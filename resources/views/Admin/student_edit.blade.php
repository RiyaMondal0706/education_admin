                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="blood_group"
                                        ...
                                        <option value="A+"
                                            {{ old('blood_group', $student->blood_group) == 'A+' ? 'selected' : '' }}>A+
                                        </option>
                                        <option value="O+"
                                            {{ old('blood_group', $student->blood_group) == 'O+' ? 'selected' : '' }}>O+
                                        </option>
                                        <option value="B+"
                                            {{ old('blood_group', $student->blood_group) == 'B+' ? 'selected' : '' }}>B+
                                        </option>
                                        <option value="AB+"
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <select name="department" required>
                                        ...
                                        <option value="eng" {{ $student->department == 'eng' ? 'selected' : '' }}>
                                            Engineering
                                        </option>

                                        <option value="biz" {{ $student->department == 'biz' ? 'selected' : '' }}>
                                            Business Analytics
                                        </option>
                                    </select>
                                </div>
                                <div>
                                    ...
                                    <select name="semester" required>
                                        <option value="1" {{ $student->semester == '1' ? 'selected' : '' }}>1st
                                            Semester</option>
                                        <option value="2" {{ $student->semester == '2' ? 'selected' : '' }}>2nd
                                            Semester</option>
                                        <option value="3" {{ $student->semester == '3' ? 'selected' : '' }}>3rd
                                            Semester</option>
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" required placeholder="700001" name="zip"
                                            value="{{ old('zip', $student->zip) }}" maxlength="6"
                                            pattern="[0-9]{6}"
                                            class="w-full px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 bg-gray-50/50"
